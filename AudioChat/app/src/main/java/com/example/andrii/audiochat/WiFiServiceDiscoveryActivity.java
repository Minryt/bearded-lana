...
public class WiFiServiceDiscoveryActivity extends Activity implements
    ...
    public static final String SERVICE_INSTANCE = "_WF";
    ...
    private static AudioFileManager audioFileManager = AudioFileManager.getInstance();

    public WiFiServiceDiscoveryActivity() {
        mFileName = Environment.getExternalStorageDirectory().getAbsolutePath();
        mFileName += "/audiorecordtest.wav";
        mTempFile = Environment.getExternalStorageDirectory().getAbsolutePath();
        mTempFile += "/record_temp.raw";
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        audioManager.init(mFileName, mTempFile);
        audioFileManager.init(mFileName);
    }
